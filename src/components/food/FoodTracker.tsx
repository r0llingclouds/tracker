...
export function FoodTracker() {
  ...
  return (
    <main className="flex-1 overflow-y-auto">
      <div className="min-h-full bg-gradient-to-br from-emerald-50 to-teal-50 dark:from-black dark:to-zinc-950">
        <div className="container mx-auto px-4 py-8 max-w-4xl">
          <header className="text-center mb-8">
            <h1 className="text-4xl font-bold text-emerald-800 dark:text-emerald-400 mb-2">Food Tracker</h1>
            <p className="text-zinc-600 dark:text-zinc-400">Track your daily nutrition intake</p>
          </header>
          ...
          <div className="grid gap-6">
            ...
            <div className="bg-white dark:bg-zinc-950 rounded-2xl shadow-lg p-6">
              <h2 className="text-xl font-semibold text-zinc-800 dark:text-zinc-50 mb-4">Log Food</h2>
              <FoodSearch 
            ...
            <div className="bg-white dark:bg-zinc-950 rounded-2xl shadow-lg p-6 border-2 border-amber-100 dark:border-amber-800">
              <div className="flex items-center gap-2 mb-4">
                <svg className="w-6 h-6 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                </svg>
                <h2 className="text-xl font-semibold text-zinc-800 dark:text-zinc-50">Meal Lookup</h2>
            ...
            {/* AI Food Parser */}
            <div className="bg-white dark:bg-zinc-950 rounded-2xl shadow-lg p-6 border-2 border-violet-100 dark:border-violet-800">
              <div className="flex items-center gap-2 mb-4">
                <svg className="w-6 h-6 text-violet-600 dark:text-violet-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
                <h2 className="text-xl font-semibold text-zinc-800 dark:text-zinc-50">AI Food Parser</h2>
              </div>
              <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
            ...
            {/* Add New Food Form */}
            <div className="bg-white dark:bg-zinc-950 rounded-2xl shadow-lg p-6">
              <h2 className="text-xl font-semibold text-zinc-800 dark:text-zinc-50 mb-4">Add New Food Manually</h2>
              <FoodForm onFoodCreated={handleFoodCreated} />
            </div>

            {/* Today's Log */}
            <div className="bg-white dark:bg-zinc-950 rounded-2xl shadow-lg p-6">
              <h2 className="text-xl font-semibold text-zinc-800 dark:text-zinc-50 mb-4">Today's Log</h2>
