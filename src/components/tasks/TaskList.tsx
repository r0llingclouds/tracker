...
export function TaskList() {
  ...
  return (
    <main className="flex-1 bg-white dark:bg-black flex flex-col h-screen overflow-hidden">
      <header className="px-6 py-4 border-b border-zinc-200 dark:border-zinc-800">
        <h2 className="text-2xl font-bold text-zinc-900 dark:text-zinc-50">{getViewTitle()}</h2>
        <p className="text-sm text-zinc-600 dark:text-zinc-400 mt-1">{getViewSubtitle()}</p>
      </header>
      
      <div className="flex-1 overflow-y-auto">
        {isEmpty ? (
          <div className="flex flex-col items-center justify-center h-full text-zinc-600 dark:text-zinc-400">
            ...
            <p className="text-sm mt-1">Press <kbd className="font-mono bg-zinc-100 dark:bg-zinc-800 px-1.5 py-0.5 rounded">space+n</kbd> to add one</p>
          </div>
          ...
          <div>
            ...
            {upcomingData.overdueTasks.length > 0 && (
              <div className="mb-2">
                <div className="sticky top-0 bg-zinc-100 dark:bg-zinc-900 px-6 py-2 border-b border-zinc-300 dark:border-zinc-700 flex items-center gap-2">
                  ...
                  <span className="font-semibold text-zinc-900 dark:text-zinc-50">Overdue</span>
                  <span className="text-xs text-zinc-600 dark:text-zinc-400">{upcomingData.overdueTasks.length}</span>
                </div>
            ...
            {upcomingData.pastDeadlineTasks.length > 0 && (
              <div className="mb-2">
                <div className="sticky top-0 bg-zinc-100 dark:bg-zinc-900 px-6 py-2 border-b border-zinc-300 dark:border-zinc-700 flex items-center gap-2">
                  ...
                  <span className="font-semibold text-zinc-900 dark:text-zinc-50">Past Deadline</span>
                  <span className="text-xs text-zinc-600 dark:text-zinc-400">{upcomingData.pastDeadlineTasks.length}</span>
                </div>
                <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
            ...
            {upcomingData.upcomingGroups.map(group => (
              <div key={group.projectId ?? 'inbox'} className="mb-2">
                {/* Project header */}
                <div className="sticky top-0 bg-zinc-50 dark:bg-zinc-900 px-6 py-2 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-2">
                  {group.color ? (
                    <span 
                  ...
                  <span className="font-medium text-zinc-700 dark:text-zinc-300">{group.projectName}</span>
                  <span className="text-xs text-zinc-600 dark:text-zinc-400">{group.tasks.length}</span>
                </div>
                {/* Tasks in this group */}
                <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
            ...
            {directAreaTasks.length > 0 && (
              <div className="mb-2">
                <div className="sticky top-0 bg-zinc-50 dark:bg-zinc-900 px-6 py-2 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-2">
                  ...
                  <span className="font-medium text-zinc-700 dark:text-zinc-300">Tasks</span>
                  <span className="text-xs text-zinc-600 dark:text-zinc-400">{directAreaTasks.length}</span>
                </div>
                <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
              ...
              return (
                <div key={project.id} className="mb-2">
                  <div className="sticky top-0 bg-zinc-50 dark:bg-zinc-900 px-6 py-2 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-2">
                    ...
                    <span className="text-xs text-zinc-600 dark:text-zinc-400">{projectTasks.length}</span>
                  </div>
                  <div className="divide-y divide-zinc-100 dark:divide-zinc-800">
